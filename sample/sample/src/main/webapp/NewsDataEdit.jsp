...
<div class="login-container">
        ...
        <form action="/update" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
            ...
            <input type="hidden" id="newsId" value="<%= request.getParameter("id") %>">
    ...
    <script>
        $(document).ready(function() {
            ...
            if (newsId) {
                // Fetch news data based on ID from URL query parameter
                $.ajax({
                    url: '/news/' + newsId,
                    type: 'GET',
                    success: function(news) {
                        // Populate the form fields with the received news data
                        $('#heading').val(news.heading);
                        $('#paragraph').val(news.paragraph);
                    },
