...
<div class="signin-container">
    ...
    <a class="inside" href="/signinasadmin">Signin as Admin</a>
    <a class="inside" href="/home">Back</a>
</div>

<a href="/deleteuser" class="delete">Delete User</a> <!-- Hyperlink below the div -->
